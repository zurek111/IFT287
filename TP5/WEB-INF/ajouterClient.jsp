		...
		<div class="container">
			...
			<form action="Accueil" method="POST">
			    ...
			    <div class="form-group">
			    	...
			    	<input class="form-control" type="NUMBER" name="age" min="0" value="<%= request.getAttribute("age") != null ? (String)request.getAttribute("age") : "" %>">
			    </div>
			    <div class="form-group">
				...
				<input class="btn btn-primary" type="SUBMIT" name="ajouter" value="Ajouter le membre">
			</form>
			</div>
		</div>
		<br>
