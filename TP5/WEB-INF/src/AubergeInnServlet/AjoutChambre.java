...
public class AjoutChambre extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        System.out.println("Servlet Inscription : POST dispatch vers ajouterChambre.jsp");
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (AubergeInnHelper.peutProceder(getServletContext(), request, response))
        {
            System.out.println("Servlet Inscription : GET dispatch vers ajouterChambre.jsp");
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/ajouterChambre.jsp");
            dispatcher.forward(request, response);
        }
    }
