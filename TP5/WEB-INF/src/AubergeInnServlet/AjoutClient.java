...
/**
 * Servlet qui g�re l'ajout d'un client au syst�me de gestion d'aubergeInn
 * 
 * <pre>
...
public class AjoutClient extends HttpServlet
{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        System.out.println("Servlet Inscription : POST dispatch vers ajouterClient.jsp");
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (AubergeInnHelper.peutProceder(getServletContext(), request, response))
        {
            System.out.println("Servlet Inscription : GET dispatch vers ajouterClient.jsp");
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/ajouterClient.jsp");
            dispatcher.forward(request, response);
        }
    }
