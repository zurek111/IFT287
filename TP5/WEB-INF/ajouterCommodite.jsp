...
<html>
	...
	<body>
		<div class="container">
			<h1 class="text-center">Ajout d'une commodité</h1>
			...
			<form action="Accueil" method="POST">
			    ...
			    <div class="form-group">
			    	<label for="prix">Surplus de prix</label>
				...
				<input class="btn btn-primary" type="SUBMIT" name="ajouter" value="Ajouter la commodité">
			</form>
			</div>
		</div>
		<br>
